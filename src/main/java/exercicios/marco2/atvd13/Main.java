...
public class Main {
    public static void main(String[] args) {
        MapaHashVetorAlunos mapaAlunos = new MapaHashVetorAlunos(10, 0.75f);
        ...
        System.out.println("Mapa Alunos: " + mapaAlunos.toString());
        mapaAlunos.put(aluno9.getMatricula(), aluno9); // VAI REALIZAR RESIZE() E REHASH(), POIS O FATOR DE CARGA É 0.75
        System.out.println("Mapa Alunos: " + mapaAlunos.toString());
